...
from modules.correlation import get_numeric_cols, compute_correlation_matrix, find_high_corr_pairs
...
def render_correlation_content(config, threshold, max_cols_str, active_vars, stat_tab, key):
